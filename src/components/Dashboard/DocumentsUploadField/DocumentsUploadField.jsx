  ...
  return (
      <div className="my-2 w-full grid-cols-1">
        ...
        {type === "file" && !completed ? (
          ...
          <Button className="w-full bg-primary rounded-lg p-6 text-md" hasChild>
            <Link to={link}>{label}</Link>
          </Button>
        ) : (
          <Button className="border bg-transparent border-green-500 rounded-lg text-primary w-full p-6 text-md">
            Accepted
          </Button>
        )}
