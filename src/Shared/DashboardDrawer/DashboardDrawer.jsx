...
const DashboardDrawer = () => {
  return (
    <aside className=" flex flex-row h-[50px] rounded-lg mmd:rounded-auto mmd:h-auto mmd:flex-col w-[94%] mmd:w-fit mb-[10px] mmd:mb-0 border bg-[#595959] py-5 rounded-r-xl overflow-hidden mt-16 mmd:mt-none justify-center mmd:justify-auto pointer-events-auto">
      <NavLink
        to="/dashboard"
        className={({ isActive }) =>
          isActive
