    ...
    return (
        ...
        <div className="">
          <div className="relative w-full min-w-[180px] h-10">
            <select name="datePosted" className="w-full h-full bg-transparent text-blue-gray-700 font-sans font-normal outline outline-0 focus:outline-0 disabled:bg-blue-gray-50 disabled:border-0 transition-all border focus:border-2 text-sm px-3 rounded-[7px] border-blue-gray-200 outline-none border-[#595959] my-auto">
